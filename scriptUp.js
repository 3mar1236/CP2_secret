...
import { colordropdownEventHandler, getCSSVariableById, flipFlipButton } from './helperFunctions.js';
                        ...
                        <div class="horizontal-line-divider"></div>
                            <div class="new-node-element-connection-container">
                                ...
                                <select id="element-connection-dropdown" class='element-connection-dropdown' name="dropdown">
                                    <option value="new" selected>New element</option>
                                    <option value="split">Split element</option>
                                </select>
                        </div>
                    </div>
